function initCanvas(){
    ...
    // Definir límites para las posiciones aleatorias
var minX = 0;  // Valor mínimo en el eje x
var maxX = 700;  // Valor máximo en el eje x
var minY = -300;  // Valor mínimo en el eje y
var maxY = -20;  // Valor máximo en el eje y

// Función para generar una posición aleatoria en el rango dado
function generarPosicionAleatoria(min, max) {
  return Math.random() * (max - min) + min;
}

// Crear instancias de enemigos con posiciones aleatorias
var enemy1 = new enemyTemplate({id: "enemy1", x: generarPosicionAleatoria(minX, maxX), y: generarPosicionAleatoria(minY, maxY), w: 50, h: 30 });
var enemy2 = new enemyTemplate({id: "enemy2", x: generarPosicionAleatoria(minX, maxX), y: generarPosicionAleatoria(minY, maxY), w: 50, h: 30 });
// Agregar más instancias de enemigos con posiciones aleatorias según sea necesario

// Segundo grupo de enemigos
var enemy31 = new enemyTemplate({ id: "enemy31", x: generarPosicionAleatoria(minX, maxX), y: generarPosicionAleatoria(minY, maxY), w: 50, h: 30, image: enemiespic2 });
var enemy32 = new enemyTemplate({ id: "enemy32", x: generarPosicionAleatoria(minX, maxX), y: generarPosicionAleatoria(minY, maxY), w: 50, h: 30, image: enemiespic2 });
// Agregar más instancias de enemigos con posiciones aleatorias para el segundo grupo
    ...
    var enemies = [
                   ...
                   enemyTemplate({id: "enemy21", x: generarPosicionAleatoria(minX, maxX), y: generarPosicionAleatoria(minY, maxY), w: 50, h: 30 }),
                   enemyTemplate({id: "enemy22", x: generarPosicionAleatoria(minX, maxX), y: generarPosicionAleatoria(minY, maxY), w: 50, h: 30 }),
                   enemyTemplate({id: "enemy23", x: generarPosicionAleatoria(minX, maxX), y: generarPosicionAleatoria(minY, maxY), w: 50, h: 30 }),
                   enemyTemplate({id: "enemy24", x: generarPosicionAleatoria(minX, maxX), y: generarPosicionAleatoria(minY, maxY), w: 50, h: 30 }),
                   enemyTemplate({id: "enemy25", x: generarPosicionAleatoria(minX, maxX), y: generarPosicionAleatoria(minY, maxY), w: 50, h: 30 }),
                   enemyTemplate({id: "enemy26", x: generarPosicionAleatoria(minX, maxX), y: generarPosicionAleatoria(minY, maxY), w: 50, h: 30 })
                  ];
    ...
    var renderEnemies = function (enemyList) {
        for (var i = 0; i < enemyList.length; i++) {
            ...
            ctx.drawImage(enemyList[i].image, enemyList[i].x, enemyList[i].y += .2, enemyList[i].w, enemyList[i].h);
    ...
    function Launcher(){
        ...
        this.hitDetectLowerLevel = function(enemy){
            ...
            if(enemy.y > 550){
                ...
                this.gameStatus.message = 'El enemigo\nha pasado la línea';
            }
